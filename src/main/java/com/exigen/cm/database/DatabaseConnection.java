...
//    private final static Map<Connection, Map<String, Statement>> statements = new WeakHashMap<Connection, Map<String, Statement>>();
    private final static Map<Connection, Map<String, Statement>> statements = Collections.synchronizedMap( new ReferenceIdentityMap(ReferenceIdentityMap.WEAK, ReferenceIdentityMap.HARD, true) );
...
/*        try {
	...
	protected /*abstract*/ Connection createConnection() throws Exception { throw new UnsupportedOperationException(); }
